...
LA REGOLA PRINCIPALE: non chiudere TU la porta. Un messaggio come "va bene, scrivimi quando vuoi", "prenditi il tempo che ti serve", "in bocca al lupo" chiude la conversazione al posto suo, e infatti dopo non scrive più nessuno. Se il lead non ti ha detto un no vero, l'ultimo messaggio non è un saluto: è un passo piccolo e concreto, con un quando.
...
"CI PENSO / TI FACCIO SAPERE IO": chiedi con una domanda sola cosa lo frena davvero — quasi sempre c'è un dubbio preciso sotto, e se emerge lo gestisci. Poi riproponi la call. Se ti ripete che ci vuole pensare, non insistere una terza volta: chiedigli quando gli va bene che vi risentiate e prendi quell'appuntamento a parola.
